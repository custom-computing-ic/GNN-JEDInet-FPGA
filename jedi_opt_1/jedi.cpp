...
void jedi(
        ...
        #pragma HLS ARRAY_PARTITION variable=B_top complete dim=2
        #pragma HLS ARRAY_PARTITION variable=B_bot complete dim=2
        #pragma HLS ARRAY_PARTITION variable=B_top complete dim=1
        #pragma HLS ARRAY_PARTITION variable=B_bot complete dim=1
        
        // mmm1, input * Rr
        nnet::jedi1_mmm_rr<data_T, res_T, typename CONFIG_T::mult_1>(in_dup1, B_top);
        // mmm2, input * Rs
        nnet::jedi1_mmm_rs<data_T, res_T, typename CONFIG_T::mult_2>(in_dup2, B_bot);
        // concat
        ...
        #pragma HLS ARRAY_PARTITION variable=E_bar complete dim=0
        // multiply by R_r_T
